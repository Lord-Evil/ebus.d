...
D_FLAGS=-fPIC -version=VibeLibeventDriver -version=Have_vibe_d_core -version=Have_libevent -version=Have_openssl -version=Have_vibe_d_data -version=Have_vibe_d_utils -I./include -de
...
ALL:clean
	dmd -c $(SOURCES) -odtmp $(D_FLAGS) $(LDFLAGS)
